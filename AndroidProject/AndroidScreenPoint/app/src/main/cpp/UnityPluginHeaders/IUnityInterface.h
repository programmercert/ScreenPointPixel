//
// Created by InnoCluase on 5/8/2017.
//

#ifndef ANDROIDSCREENSHOT_IUNITYINTERFACE_H
#define ANDROIDSCREENSHOT_IUNITYINTERFACE_H
...
#endif //ANDROIDSCREENSHOT_IUNITYINTERFACE_H
